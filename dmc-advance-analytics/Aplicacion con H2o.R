...
d_h2o = h2o.importFile("/home/diego/Documents/notebooks/dmc-advance-analytics/data/Fuga_CTS.csv", destination_frame = "d_csv")
...
# Particion aleatoria de la tabla, si es muy pesado se utiliza tic() y toc()
tic()
...
# Construyendo el primer algoritmo 
  # definici?n de etiquetas, target y demas.
y = "Fuga"
